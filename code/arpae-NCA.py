...
fil = 'AH_20160301_074702_07_5.nda'

ac = '/Users/j125mini/EASI/data/20160301-arpaedemo-NCA*cell1'
...
ax_tr.imshow(bigdextr,aspect="auto",clim=[0,25])
#ax_tr.set_yticks(tickpt)
ax_tr.set_ylim([400,100])
#ax_tr.set_yticklabels(TR_ticktof)
ax_tr.set_ylabel("Transmission\nToF ($\mu$s)")
ax_tr.set_xticks([])

ax_pe.imshow(bigdexpe,aspect="auto",clim=[0,25])
ax_pe.set_ylim([400,100])
ax_pe.set_ylabel("Reflection\nToF ($\mu$s)")
ax_pe.set_xticks([])
ax_cur.set_xlim(0,array(tim)[-1]/3600)
ax_pot.set_xlim(0,array(tim)[-1]/3600)
